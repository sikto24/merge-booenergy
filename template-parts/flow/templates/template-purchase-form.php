<?php
// Step title
$boo_purchase_flow_field_frist_step_title = get_theme_mod( 'boo_purchase_flow_field_frist_step_title', 'Fyll i dina uppgifter' );
$boo_purchase_flow_field_second_step_title = get_theme_mod( 'boo_purchase_flow_field_second_step_title', 'Vart ska elen?' );
$boo_purchase_flow_field_three_step_title = get_theme_mod( 'boo_purchase_flow_field_three_step_title', 'Anläggningsuppgifter' );
$boo_purchase_flow_field_four_step_title = get_theme_mod( 'boo_purchase_flow_field_four_step_title', 'Signering' );
	...
	<div class="row gy-4">
				...
				<div class="step-container active-step-container">
					<div data-step="1" class="d-flex gap-2 align-items-center justify-content-between step-head">
						<div class="d-flex gap-2 align-items-center">
							...
							<h6><?php echo esc_html__( $boo_purchase_flow_field_frist_step_title, 'boo-energy' ); ?>
							</h6>
						</div>
					...
					<div class="pt-3 step-content">
						<div class="form-group">
							<label for="person-number"
								class="form-label"><?php echo esc_html__( 'Fyll i ditt personnummer', 'boo-energy' ); ?>
								<span class="asterisk">*</span></label>
							<div class="input-container">
								<input type="text" class="form-control" id="person-number" name="person-number"
									placeholder="ÅÅÅÅMMDD-XXXX" maxlength="13"
							...
							<p id="person-number-error" class="error-validation bread-small pt-1 hidden">
								...
								<?php echo esc_html__( 'Vänligen ange ett giltigt personnummer', 'boo-energy' ); ?>
							</p>
							...
							<div class="form-group">
								...
								<div class="input-container">
									<input type="email" class="form-control" id="email" name="email"
										placeholder="Ange din e-postadress" maxlength="255" required>
									<span class="checkmark">
										<i class="fa-solid fa-check" style="color: #009A44;"></i>
									</span>
				...
				<div class="step-container active-step-container">
					<div data-step="2" class="d-flex gap-2 align-items-center justify-content-between step-head">
						<div class="d-flex gap-2 align-items-center">
							...
							<h6><?php echo esc_html__( $boo_purchase_flow_field_second_step_title, 'boo-energy' ); ?>
							</h6>
						</div>
						<img src="<?php echo get_template_directory_uri() ?>/flow/assets/pencil_icon.svg"
							alt="Edit icon" class="step-edit-icon">
					...
					<p>1*0 0* St*ckh*lm</p> -->
						...
						<div id="new-address-root" class="mt-3">
							<div class="d-flex align-items-center gap-2 ">
								<input class="" type="radio" name="address-option" id="new-address" value="new-address"
									style="flex-shrink: 0;">
				...
				<div class="step-container active-step-container">
					<div data-step="3" class="d-flex gap-2 align-items-center justify-content-between step-head">
						<div class="d-flex gap-2 align-items-center">
							...
							<h6><?php echo esc_html__( $boo_purchase_flow_field_three_step_title, 'boo-energy' ); ?>
							</h6>
						</div>
						<img src="<?php echo get_template_directory_uri() ?>/flow/assets/pencil_icon.svg"
							alt="Edit icon" class="step-edit-icon">
					...
					<div class="pt-3 step-content">
						<div id="prefilled-facility-root" class="address-container-selected">
							<div class="d-flex align-items-center gap-2">
								<input type="radio" style="flex-shrink: 0;" id="facility-boo" name="facility-option"
									value="facility-boo" checked>
						...
						<div id="own-filled-facility" class="mt-3">
							<div class="d-flex align-items-center gap-2 ">
								<input class="" type="radio" style="flex-shrink: 0;" name="facility-option"
									id="own-filled-facility" value="own-filled-facility">
				...
				<div class="step-container active-step-container">
					<div data-step="4" class="d-flex gap-2 align-items-center justify-content-between step-head">
						<div class="d-flex gap-2 align-items-center">
							...
							<h6><?php echo esc_html__( $boo_purchase_flow_field_four_step_title, 'boo-energy' ); ?>
							</h6>
						</div>
						<img src="<?php echo get_template_directory_uri() ?>/flow/assets/pencil_icon.svg"
							alt="Edit icon" class="step-edit-icon">
					...
					<div class="pt-3 step-content">
						...
						<div id="authorize-contract-view" class="current-address-container">
							...
							<p class="fw-normal mt-1" style="font-size: 12px;">Länk öppnas i nytt fönster och signering
								sker säkert och isamarbete med Scrive.
							</p>
						</div>
		...
		<div class="col-lg-4 my-5">
			<div class="card p-3">
				...
				<div class="package-discount-container d-flex flex-column align-items-end hidden">
				...
				<p class="price-summary-info-text">
					Din slutliga månadskostnad kommer att beräknas på din faktiska
					elanvändning
					och det gällande elpriset under
					perioden. Kostnader kring elnät ingår inte utan kommer från din elnätsägare.
				</p>
			</div>
		</div>
	</div>
	...
	<div id="signing-modal" class="modal fade" data-backdrop="static" role="dialog" aria-labelledby="exampleModalLabel">
		<div class="modal-dialog custom-modal-container" role="document">
			<div class="gap-2 modal-content d-flex flex-column align-items-center justify-content-center h-100">
				<div class="text-center modal-content-container">
					...
					<div id="after-sign-view" class="d-flex gap-3 align-items-center hidden">
						...
						<h1 id="sign-title" class="py-3 mb-3" style="color: #101010;">Signerat</h1>
					</div>
					<button id="sign-button" class="primary-button"><span class="hidden" style="padding-right: 8px;">
							<i class="fa-solid fa-circle-notch spin"></i>
						</span> Signera fullmakt</button>
					<!-- <a id="scrive-link-attorny" href="" class="primary-button mt-3" target="_blank" rel="noopener noreferrer">Signera fullmakt</a> -->
				</div>
			...
			<div class="gap-2 modal-content d-flex flex-column align-items-center justify-content-center h-100">
				<div class="text-center modal-content-container">
					...
					<div id="contract-after-sign-view" class="d-flex gap-3 align-items-center hidden">
						<i class="fa fa-check fw-bold" style="color: #009A44; font-size: xx-large;"></i>
						<h1 id="contract-sign-title" class="py-3" style="color: #101010;">Signerat</h1>
					</div>
					<button id="sign-button-contract" class="primary-button"><span class="hidden"
							style="padding-right: 8px;">
							<i class="fa-solid fa-circle-notch spin"></i>
						</span>Signera elavtalet</button>
					<!-- <a id="scrive-link-contract" href="" class="primary-button" target="_blank" rel="noopener noreferrer">Signera elavtalet</a> -->
				</div>
				<div class="current-address-container signing-error hidden">
					<div class="text-center">
						<p class="error-message">
			...
			<div class="gap-2 modal-content">
				<div class="custom-price-modal">
					...
					<p id="custom-price-modal-description" class="bread pt-4">Elpriset som visas här baseras alltid på
						förra månadens elpris, din angivna förbrukning och vart du bor</p>
